...
class InventoryMovement(BaseModel):
    ...
    variant = models.ForeignKey('catalog.ProductVariant', on_delete=models.SET_NULL, blank=True, null=True, related_name='inventoryMovements')
    orderItem = models.ForeignKey('orders.OrderItem', on_delete=models.SET_NULL, blank=True, null=True, related_name='inventoryMovements')
    ...
    class Meta:
        indexes = [
            models.Index(fields=['product', 'createdAt']),
            models.Index(fields=['variant', 'createdAt']),
...
class StockAlert(BaseModel):
    ...
    class Meta:
        indexes = [
            models.Index(fields=['isActive', 'lastTriggeredAt'])
        ]
...
class BackInStockSubscription(BaseModel):
    ...
    variant = models.ForeignKey('catalog.ProductVariant', on_delete=models.SET_NULL, blank=True, null=True, related_name='backInStockSubscribers')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['product', 'isNotified']),
            models.Index(fields=['variant', 'isNotified'])
        ]
